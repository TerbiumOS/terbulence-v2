...
if(localStorage.getItem("pass") == "new" || localStorage.getItem("pass") == null) {
    ...
    <div style="display: flex; border: 1px; border #ffffff10; width: 120px; height: 120px; background-image: url(&quot;./pfp.png&quot;)"></div>
    <h1>Welcome Back!</h1>
    <br>    
    <p class="passState">Create A Password</p>
        ...
        <br>
        <a style="margin-top: -17px;"class="skip misc">Dont make a password</a>
